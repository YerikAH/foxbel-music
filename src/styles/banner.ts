...
export const HeadlinePrincipal = styled.h1`
    font: normal normal 700 1.2rem/1.75rem var(--font-principal);
    color: var(--white);
`
...
export const TextSpan = styled.span`
        font: normal normal 700 0.625rem/0.75rem var(--dark-red);
`

export const TextBody = styled.p`
    font: normal normal 700 0.75rem/1.25rem var(--font-principal);
    color: var(--white);
    margin-top: 1.25rem;
`
...
export const ButtonStroker = styled.button`
    ...
    border:  ${props => props.className === 'stroke' ? 'var(--red-principal)': 'none'};
